...
<head>
    ...
    <style>
       ...
       .col-sm-3{
        ...
        #areaName,#treeKind,#treeAdvantage{
        	color:orange;
        }
    </style>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
            				<form action="../AddAreaServlet" method="get">
                            <div class="row">
                                <div class="col-sm-3 col-sm-push-4">名称:</div>
                                <div class="col-sm-3 col-sm-push-2">
                                <input oninput="setCustomValidity('')"
                    				   pattern="^[\u4e00-\u9fa5]{0,10}$"
                    				   oninvalid="setCustomValidity('请输入汉字，最多10位');"
                    				   placeholder="请输入汉字，最多10位"
                    				   required type="text" name="areaName"/></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 col-sm-push-4"> 林种:</div>
                                <div class="col-sm-3 col-sm-push-2">
                                <input oninput="setCustomValidity('')"
                    				   pattern="^[\u4e00-\u9fa5]{0,5}$"
                    				   oninvalid="setCustomValidity('请输入汉字，最多5位');"
                    				   placeholder="请输入汉字，最多5位"
                    				   required type="text" name="treeKind"/></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 col-sm-push-4"> 优势树种:</div>
                                <div class="col-sm-3 col-sm-push-2">
                                <input oninput="setCustomValidity('')"
                    				   pattern="^[\u4e00-\u9fa5]{0,5}$"
                    				   oninvalid="setCustomValidity('请输入汉字，最多5位');"
                    				   placeholder="请输入汉字，最多5位"
                    				   required type="text" name="treeAdvantage"/></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 col-sm-push-4"> 地类:</div>
                                <div class="col-sm-3 col-sm-push-2">
                                    <select name="areaKind">
                                        <option value="林地">林地</option>
                                        <option value="蔬林地">蔬林地</option>
                                        <option value="灌木林">灌木林</option>
