...
<head>
    ...
    $(function(){
    	var currentPage=1;
		$.post("../DiseaseServlet",{currentPage:currentPage},callBack,"JSON")
		...
		$("input[type=button]").click(function(){
    		...
    		$.post("../DiseaseServlet",{currentPage:currentPage,name:name,symptom:symptom},callBack,"JSON")
    	})
	});
    function callBack(data){
    	var $table = $("table");
    	$table.empty();
    	$("table").append("<tr><th>名称</th><th>主要危害</th><th>发病规律</th><th>操作</th></tr>");
    	$.each(data.list,function(i,e){
			$("table").append("<tr><td>"+e.name+"</td><td>"+e.harm+"</td><td>"+e.law+"</td><td><a href=../DiseaseFindServlet?id="+e.id+">查看详细信息</a></td></tr>");
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-sm-push-1" id="finds">
                            <label>病害名称:<input type="text" name="name"/></label>
                            <label> 发病症状: <input type="text" name="symptom"/></label>
            ...
            <div class="col-sm-12" id="sasa">
                ...
                <div id="tj"><a href=adddisease.jsp>添加新病害</a></div>
            </div>
        </div>
    </div>
