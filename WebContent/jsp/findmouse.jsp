        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 "><label >${MouseBean.name }</label></div>
                    <div class="col-sm-3 ">繁殖:</div>
                    <div class="col-sm-3 col-sm-pull-2"><label >${MouseBean.breed }</label></div>
                </div>
                <div class="row">
                    <div class="col-sm-3 col-sm-push-2">食物:</div>
                    <div class="col-sm-3"><label >${MouseBean.food }</label></div>
                    <div class="col-sm-3">天敌:</div>
                    <div class="col-sm-3 col-sm-pull-2"><label >${MouseBean.enemy }</label> </div>
                </div>
                <div class="row">
                    <div class="col-sm-3 col-sm-push-2">图片:</div>
                    <div class="col-sm-3"><img src=/ControlSystem/img/${MouseBean.image } height="100px"  width=150px></div>
                    <div class="col-sm-3">主要危害:</div>
                    <div class="col-sm-3 col-sm-pull-2"><label >${MouseBean.harm }</label></div>
                </div>
                <div class="row">
                    <div class="col-sm-3 col-sm-push-2">防治措施:</div>
                    <div class="col-sm-3"><label >${MouseBean.defend }</label> </div>
                </div>

                <div class="row">
                    <div class="col-sm-3  col-sm-push-5"> <a href="jsp/mouse.jsp">返回</a></div>
                </div>
            </div>
        </div>
    </div>
