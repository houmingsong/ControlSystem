        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-sm-pull-2"><label >${thingBean.condition }</label> </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-sm-pull-2"><label >${thingBean.defend}</label> </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-3  col-sm-push-5"> <a href="jsp/event.jsp">返回</a></div>
                </div>
            </div>
        </div>
    </div>
