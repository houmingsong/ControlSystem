    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <form action="../DiseaseAddServlet" method="post" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-sm-push-4">病原:</div>
                        <div class="col-sm-3 col-sm-push-2"><input type="text" name="pathogen" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required /></div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-sm-push-4">发病症状:</div>
                        <div class="col-sm-3 col-sm-push-2">
                            <textarea name="symptom" id="" cols="22" rows="3" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required ></textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-sm-push-4">发病规律:</div>
                        <div class="col-sm-3 col-sm-push-2">
                            <textarea name="law" id="" cols="22" rows="3" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required ></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-sm-push-2">
                            <textarea name="defend" id="" cols="22" rows="3" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required ></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-sm-push-2"><input type="text" name="harm" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required /></div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-sm-push-4"> 图片:</div>
                        <div class="col-sm-3 col-sm-push-2">
