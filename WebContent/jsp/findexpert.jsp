        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-sm-pull-2"><img  src=/ControlSystem/img/${expertBean.image} width="100px" height="100px"></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-sm-pull-2"><label >${expertBean.job}</label></div>
                </div>
                <div class="row">
                    <div class="col-sm-3 col-sm-push-2">电话:</div>
                    <div class="col-sm-3"><label >${expertBean.tel}</label> </div>
                    <div class="col-sm-3 ">工作单位:</div>
                    <div class="col-sm-3 col-sm-pull-2"><label >${expertBean.company}</label> </div>
                </div>
                <div class="row">
                    <div class="col-sm-3 col-sm-push-2">通讯地址:</div>
                    <div class="col-sm-3"><label >${expertBean.address}</label> </div>
                    <div class="col-sm-3">邮箱:</div>
                    <div class="col-sm-3 col-sm-pull-2"><label >${expertBean.email}</label> </div>
                </div>

                <div class="row">
                    <div class="col-sm-3  col-sm-push-5"> <a href="jsp/expert.jsp">返回</a></div>
                </div>
            </div>
        </div>
    </div>
