    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <form action="../MouseAddServlet" method="post" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-sm-push-4">食物:</div>
                        <div class="col-sm-3 col-sm-push-2"><input type="text" name="food" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required /></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-sm-push-2">
                            <textarea name="harm" id="" cols="22" rows="3" oninput="setCustomValidity('')"
                    pattern="^[\u4e00-\u9fa5]{0,13}$"
                    oninvalid="setCustomValidity('请输入汉字，最多13位');"
                    placeholder="请输入汉字，最多13位"
                    required ></textarea>
