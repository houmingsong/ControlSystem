...
<head>
    ...
    $(function(){
    	 var currentPage=1;
    	$.post("../WormServlet",{currentPage:currentPage},callBack,"JSON");
    	...
    	$("input[type=button]").click(function(){
    		...
    		$.post("../WormServlet",{currentPage:currentPage,name:name,host:host},callBack,"JSON")
    	})
    ...
    function callBack(data){
    	var $table = $("table");
    	$table.empty();
    	$("table").append("<tr><th>名称</th><th>寄主</th><th>主要危害</th><th>操作</th></tr>");
    	$.each(data.list,function(i,e){
			$("table").append("<tr><td>"+e.name+"</td><td>"+e.host+"</td><td>"+e.harm+"</td><td><a href=../WormFindServlet?id="+e.id+">查看详细信息</a></td></tr>");
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-sm-push-1" id="finds">
                            <label>害虫名:<input type="text" name="name"/></label>
                            <label>寄主:<input type="text" name="host"/></label>
            ...
            <div class="col-sm-12" id="sasa">
                ...
                <div id="tj"><a href=addworm.jsp>添加新虫害</a></div>
            </div>
        </div>
    </div>
