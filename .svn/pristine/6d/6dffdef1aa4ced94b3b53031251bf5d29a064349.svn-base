...
<jsp:include page="remove.jsp" flush="false"/>
   $(function(){
	 ...
	 var startDate=null;
	 var endDate=null;
	 $.getJSON("../TalkServlet",{currentPage:currentPage,name:name,condition:condition,location:location,startDate:startDate,endDate:endDate},fillData);
	 });
...
function fillData(data){
	...
	$.each(data.list, function(i,e){
		...
		var tr = "<tr><td>" + name+ "</td><td>" +time + "</td><td>" + areaName + "</td><td>" + defend+ "</td><td>" +condition+ "</td><td><a href=../ExpertTalkServlet?id="+e.id +">专家会商</a></td></tr>";
		$table.append(tr);
	});
